...
@section('title', __('Pendidikan & Pelatihan | Our Experience - Page'))
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><i class="fas fa-graduation-cap mr-2"></i> Pendidikan & Pelatihan
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4>Add new Pendidikan/Pelatihan</h4>
                            ...
                            <div class="modal-body">
                                <div class="container">
                                    <form action="{{ route('admin.exp.pendidikan.pendidikan-upload') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-10">
                    ...
                    <table id="commonTable" class="table table-hover">                
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;">{{$stu->year}}</td>
                                <td style="vertical-align: middle;">{{$stu->title}}</td>
                                <td style="vertical-align: middle;">{{Str::limit($stu->desc,200)}}</td>
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-sm btn-primary btn-edit" href="#" data-id="{{$stu->id}}" data-toggle="modal" data-target="#editRow"><i class="fas fa-pen mr-2"></i>Edit</a>
                                    <a class="btn btn-sm btn-danger study-delete" href="#" data-id="{{$stu->id}}"><i class="fas fa-trash mr-2"></i> Delete</a>
                                </td>
